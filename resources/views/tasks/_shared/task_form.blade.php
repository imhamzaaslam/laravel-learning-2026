        ...
        <form id="create-task-form">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="user_id" name="user_id">
                    ...
                    @foreach ($users as $user)
                        <option {{ isset($task) && $task->user_id == $user->id ? 'selected' : '' }}
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control" id="due_date" name="due_date"
                    value="{{ isset($task) ? $task->due_date->format('Y-m-d') : '' }}">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="estimated_time" name="estimated_time"
                    value="{{ isset($task) ? $task->estimated_time : '' }}">
            </div>

            <div class="mb-3">
                <label for="estimated_time" class="form-label">Attachments</label>
